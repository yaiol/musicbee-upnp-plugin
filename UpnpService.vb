...
Partial Public Class Plugin
    Friend MustInherit Class UpnpService
        ...
        Private ReadOnly descriptionData As Byte()
        Friend Delegate Sub SendEventDelegate(sid As String, uri As Uri)

        Public Sub New(server As UpnpServer, serviceTypeName As String, serviceId As String, controlUrl As String, eventSubUrl As String, SCPDURL As String)
            Me.server = server
