...
Partial Public Class Plugin
    Friend MustInherit Class Encoder
    End Class  ' Encoder

    <SuppressUnmanagedCodeSecurity()> _
    Friend NotInheritable Class AudioEncoder
        Inherits Encoder
                ...
                Select Case Codec
                    Case FileCodec.Pcm, FileCodec.Wave
                        ...
                        If Codec = FileCodec.Pcm Then
                            ...
                            ' F5 - UPnP/RFC 3551 spec is big-endian for L16/L24, but some non-compliant devices want little-endian.
                            If Not forceLittleEndian Then
                                flags = (flags Or BASSEncode.BASS_ENCODE_BIGEND)
                            End If
                        ElseIf isPartialContent Then
                            flags = (flags Or BASSEncode.BASS_ENCODE_NOHEAD)
                        End If
                        encoderCommandLine = Nothing
                    Case FileCodec.Mp3, FileCodec.Aac, FileCodec.Ogg, FileCodec.Flac
    ...
    Friend NotInheritable Class ImageEncoder
        Inherits Encoder
