...
Partial Public Class Plugin
    ...
    Public Enum FileCodec
        Unknown = -1
        AnyPcm = 0           ' kept from older SDK - used to mean "any PCM container" in transcoding decisions
        Mp3 = 1
        Aac = 2
        Flac = 3
        Ogg = 4
    ...
    Public Enum SettingId
        ...
        ' Values 4-10 - undocumented in the 2019 public SDK, kept here from the older fork.
        ' Used by the plugin's startup initialisation to mirror MusicBee's "ignore prefix" sort
        ' behaviour and play-count trigger thresholds. If MusicBee doesn't recognise a value at
        ' a guessed index, Setting_GetValue returns False and the corresponding feature degrades
        ' gracefully (no prefix stripping / no trigger threshold).
        IgnoreNamePrefixes = 4
        IgnoreNameChars = 5
        PlayCountTriggerPercent = 6
        PlayCountTriggerSeconds = 7
        SkipCountTriggerPercent = 8
        SkipCountTriggerSeconds = 9
